    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          ...
          point is captured by another team, the points are revoked.
        </td>
        <td>
          <span className="badge badge--primary">Number</span>
        </td>
      ...
      <tr>
        ...
        <td>
          <a href="#capture-rule">Capture Rule</a>
        </td>
      ...
      <tr>
        ...
        <td>The rate for a control point to recover to its current state.</td>
        <td>
          <span className="badge badge--primary">Number</span>
        </td>
        <td>0</td>
      ...
      <tr>
        ...
        <td>
          ...
          when nobody is dominating the point.
        </td>
        <td>
          <span className="badge badge--primary">Number</span>
        </td>
      ...
      <tr>
        ...
        <td>
          ...
          <br />
          <i>Takes predecence over `decay-rate`.</i>
        </td>
        <td>
          <span className="badge badge--primary">Number</span>
        </td>
      ...
      <tr>
        ...
        <td>Broadcast messages related to the control point in chat.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
      ...
      <tr>
        ...
        <td>
          Play sounds, fireworks and other effects related to the control point.
        </td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
      ...
      <tr>
        ...
        <td>Displays the control point on scoreboard.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td colspan="2">true</td>
      ...
      <tr>
        ...
        <td>Determines if this control point counts as a win condition.</td>
        <td>
          <span className="badge badge--primary">true/false</span>
        </td>
        <td colspan="2">true</td>
      ...
      <tr>
        ...
        <td>
          Specify if the control point should be hidden from all visible
          locations to the player. These locations include chat, the boss bar,
          and the scoreboard.
          <br />
          <label>NOTE:</label>
...
<span className="badge badge--danger">NOTE:</span>

_The `<king>`, `<hill>` and `<hills>` tags have been deprecated.
Use the `<control-point>` and `<control-points>` tags, which work the same but
with differrent default values._
